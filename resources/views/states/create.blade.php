  ...
  <section class="section jobs">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <!-- Multi Columns Form -->
        <form method="POST" action="{{route('states.store')}}" class="row g-3">
          @csrf
          <div class="col-md-6">
          ...
          <div class="col-md-2">
            ...
            <input type="text" value="{{old('code')}}" class="form-control" id="title" name="code">
            @error('code')
              <div class="text-danger">
                {{$message}}
              </div>
          ...
          <div class="col-md-3">
            ...
            <select id="country" name="country_id" value="{{old('country_id')}}" class="form-select">
